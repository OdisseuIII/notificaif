...
//  notificaif
//
//  Created by IFBIOTIC24 on 05/06/23.
//
...
class LoginView:UIView{
    ...
    var imagemLogin:UIImageView = {
        ...
        imagem.image = UIImage(named: "ifblogin")
    ...
    //cria a função com as propriadades da imagem no login
        ...
        func setupVisualElements() {
            ...
            NSLayoutConstraint.activate([
                ...
                imageLabel.topAnchor.constraint(equalTo: imagemLogin.bottomAnchor, constant: 5),
